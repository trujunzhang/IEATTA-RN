...
let FriendsUsingApp = require('./FriendsUsingApp');
let Navigator = require('Navigator');
let Switch = require('Switch');
let View = require('View');
let F8Header = require('F8Header');
let StatusBar = require('StatusBar');
let SharingSettingsCommon = require('./SharingSettingsCommon');

let {setSharingEnabled, logOutWithPrompt} = require('../../actions');
